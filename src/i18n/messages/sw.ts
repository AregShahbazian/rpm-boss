...
export const messages: Messages = {
  ...
  mockEngine: 'Injini ya kuigiza',
  simulated: 'Ya kuigiza - si injini halisi',
  mockSpeed: 'Kasi ya kuigiza',
  play: 'Sikiliza',
  ...
  errorListenFailed: 'Imeshindwa kuanza kusikiliza. Jaribu tena.',
  ...
  themeDark: 'Giza',
  strokeLabel: 'Injini',
  strokeTwo: 'Mizunguko 2',
  strokeFour: 'Mizunguko 4',
  cylindersLabel: 'Silinda',
  tachoSettings: 'Mipangilio ya kipima mzunguko',
