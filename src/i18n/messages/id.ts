...
export const messages: Messages = {
  ...
  mockEngine: 'Mesin simulasi',
  simulated: 'Simulasi - bukan mesin sungguhan',
  mockSpeed: 'Kecepatan simulasi',
  play: 'Putar',
  ...
  errorListenFailed: 'Tidak bisa mulai mendengarkan. Coba lagi.',
  ...
  tachoSettings: 'Pengaturan takometer',
