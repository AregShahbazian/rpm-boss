...
export const messages: Messages = {
  ...
  mockEngine: 'Імітація двигуна',
  simulated: 'Імітація - не справжній двигун',
  mockSpeed: 'Швидкість імітації',
  play: 'Прослухати',
  stopPlaying: 'Стоп',
  ...
  errorListenFailed: 'Не вдалося почати прослуховування. Спробуйте ще раз.',
  ...
  strokeLabel: 'Двигун',
  strokeTwo: '2-тактний',
  strokeFour: '4-тактний',
  cylindersLabel: 'Циліндри',
  tachoSettings: 'Налаштування тахометра',
