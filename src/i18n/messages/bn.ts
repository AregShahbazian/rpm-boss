...
export const messages: Messages = {
  ...
  mockEngine: 'সিমুলেটেড ইঞ্জিন',
  simulated: 'সিমুলেটেড - আসল ইঞ্জিন নয়',
  mockSpeed: 'সিমুলেটেড গতি',
  play: 'বাজান',
  stopPlaying: 'থামান',
  ...
  errorListenFailed: 'শোনা শুরু করা যায়নি। আবার চেষ্টা করুন।',
  ...
  strokeLabel: 'ইঞ্জিন',
  strokeTwo: '২-স্ট্রোক',
  strokeFour: '৪-স্ট্রোক',
  cylindersLabel: 'সিলিন্ডার',
  tachoSettings: 'ট্যাকোমিটার সেটিংস',
