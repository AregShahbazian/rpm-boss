...
export const messages: Messages = {
  ...
  mockEngine: 'Motor simulado',
  simulated: 'Simulado - no es un motor real',
  mockSpeed: 'Velocidad simulada',
  play: 'Reproducir',
  stopPlaying: 'Parar',
  ...
  errorListenFailed: 'No se pudo empezar a escuchar. Inténtalo otra vez.',
  ...
  themeDark: 'Oscuro',
  strokeLabel: 'Motor',
  strokeTwo: 'De 2 tiempos',
  strokeFour: 'De 4 tiempos',
  cylindersLabel: 'Cilindros',
  tachoSettings: 'Ajustes del tacómetro',
  ...
  tachoReset: 'Restablecer valores',
}
