...
export const messages: Messages = {
  ...
  mockEngine: 'Имитация двигателя',
  simulated: 'Имитация - не настоящий двигатель',
  mockSpeed: 'Скорость имитации',
  play: 'Прослушать',
  stopPlaying: 'Стоп',
  ...
  errorListenFailed: 'Не удалось начать прослушивание. Попробуйте ещё раз.',
  ...
  themeLight: 'Светлая',
  themeDark: 'Тёмная',
  strokeLabel: 'Двигатель',
  strokeTwo: '2-тактный',
  strokeFour: '4-тактный',
  cylindersLabel: 'Цилиндры',
  tachoSettings: 'Настройки тахометра',
  liveMotionLabel: 'Движение стрелки',
  liveMotionSmooth: 'Плавное',
  liveMotionStep: 'Шагами',
  dialMaxLabel: 'Максимум шкалы',
  dialRedlineLabel: 'Красная зона от',
  tachoReset: 'Сбросить настройки',
}
